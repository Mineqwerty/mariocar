	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 0, 47, 0, 9, 0, 2),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(LAYER_TRANSPARENT, 0, 0, 0, mario_000_offset_015_mesh),
				GEO_CLOSE_NODE(),
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				...
				GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 0, 47, 0, 9, 0, 2),
				GEO_OPEN_NODE(),
					GEO_ANIMATED_PART(LAYER_TRANSPARENT, 0, 0, 0, mario_000_offset_015_mesh_mat_override_metal_v3_0),
				GEO_CLOSE_NODE(),
				GEO_ASM(0, geo_mario_tilt_torso),
				GEO_ROTATION_NODE(LAYER_FORCE, 0, 0, 0),
				GEO_OPEN_NODE(),
