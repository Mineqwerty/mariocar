...
#include "wheels/model.inc.c"
#include "wheels/anims/data.inc.c"
#include "wheels/anims/table.inc.c"
#include "crosswalk/model.inc.c"
#include "crosswalk/collision.inc.c"
