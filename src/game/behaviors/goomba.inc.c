...
void bhv_goomba_init(void) {
    ...
    switch (o->oBehParams2ndByte) {
        case 12:o->oFaceAngleYaw = 0x8000; o->oMoveAngleYaw = 0x8000;
        break;
        case 13:o->oFaceAngleYaw = 0x0; o->oMoveAngleYaw = 0x0;
        break;
        case 14:o->oFaceAngleYaw = 0x4000; o->oMoveAngleYaw = 0x4000;
        break;
        case 15:o->oFaceAngleYaw = -0x4000; o->oMoveAngleYaw = -0x4000;
        break;
...
static void mark_goomba_as_dead(void) {
    gMarioState->starReqs[2] += 1;
    gMarioState->starReqs[3] += 1;
    gMarioState->starReqs[4] += 1;
if (o->oBehParams2ndByte > 10) {
    gMarioState->starReqs[16] += 1;
}
    if (o->parentObj != o) {
...
void bhv_goomba_update(void) {
    ...
    if (obj_update_standard_actions(o->oGoombaScale)) {
        ...
        // unload
        if (o->parentObj != o) {
            if (o->oDistanceToMario > 13000.0f) {
