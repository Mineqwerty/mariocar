...
u32 interact_coin(struct MarioState *m, UNUSED u32 interactType, struct Object *o) {
    ...
    gMarioState->starReqs[9] += o->oDamageOrCoinValue;
    gMarioState->starReqs[10] += o->oDamageOrCoinValue;
    gMarioState->starReqs[11] += o->oDamageOrCoinValue;
    gMarioState->starReqs[12] += o->oDamageOrCoinValue;
...
u32 interact_star_or_key(struct MarioState *m, UNUSED u32 interactType, struct Object *o) {
    ...
    if (m->health >= 0x100) {
        ...
        switch (o->oBehParams2ndByte) {
            case 16: gMarioState->starsCollected[1] = 1;
            break;
            case 11: gMarioState->starsCollected[21] = 1;
            break;
            case 12: gMarioState->starsCollected[20] = 1;
            break;
            case 13: gMarioState->starsCollected[13] = 1;
            break;
            case 14: gMarioState->starsCollected[25] = 1;
            break;
            case 15: gMarioState->starsCollected[8] = 1;
            break;
            case 17: gMarioState->starsCollected[28] = 1;
            break;
        ...
        //play_secondary_music(SEQ_STREAMED_YOU_GOT_STAR, 255, 255, 0);
        play_music(SEQ_PLAYER_LEVEL, SEQ_STREAMED_YOU_GOT_STAR, 0);
#ifndef VERSION_JP
        update_mario_sound_and_camera(m);
#endif
        ...
        return ;
        //set_mario_action(m, starGrabAction, noExit + 2 * grandStar);
    }
...
u32 interact_breakable(struct MarioState *m, UNUSED u32 interactType, struct Object *o) {
    ...
    if (interaction & INT_FAST_ATTACK_OR_SHELL) {
        attack_object(o, interaction);
        bounce_back_from_attack(m, interaction);
