...
char *starNames[] = { 
    ...
    "Crash your car 30 times",
    "Drive in cruise control",
    "Hit 5 pedestrians in 15 seconds",
    "Stay in the air for 5 seconds",
    "Smash the big window",
    "Destroy 20 objects",
    "Visit the market",
    //21
    ...
    "Drive to the edge of town",
    "Visit the go-kart track",
    "Run over the baby penguin",
    "Cross a cross-walk 30 times",
    "Find Peter",
    "Listen to all the radio tracks",
    "Mow down the basketball team"
};

char *starNamesComplete[] = { 
   COLOR "0 255 0 0" "Visit the center of town",
    COLOR "0 255 0 0" "Squash 3 goombas",
    COLOR "0 255 0 0" "Squash 10 goombas",
    COLOR "0 255 0 0" "Squash 20 goombas",
    COLOR "0 255 0 0" "Hit 2 koopas",
    COLOR "0 255 0 0" "Hit 8 koopas",
   COLOR "0 255 0 0"  "Smash a thwomp",
   COLOR "0 255 0 0"  "Visit the fountain",
   COLOR "0 255 0 0"  "Collect 10 coins",
    COLOR "0 255 0 0""Collect 50 coins",
    //11
    COLOR "0 255 0 0""Collect 100 coins",
    COLOR "0 255 0 0" "Collect 200 coins",
    COLOR "0 255 0 0""Visit the parking garage",
    COLOR "0 255 0 0""Crash your car 30 times",
   COLOR "0 255 0 0" "Drive in cruise control",
   COLOR "0 255 0 0" "Hit 5 pedestrians in 15 seconds",
   COLOR "0 255 0 0" "Stay in the air for 5 seconds",
    COLOR "0 255 0 0" "Smash the big window",
    COLOR "0 255 0 0" "Destroy 20 objects",
    COLOR "0 255 0 0" "Visit the market",
    //21
    COLOR "0 255 0 0" "Visit the gas station",
    COLOR "0 255 0 0" "HOVER above the lake",
    COLOR "0 255 0 0" "Change the radio station",
    COLOR "0 255 0 0" "Drive to the edge of town",
    COLOR "0 255 0 0" "Visit the go-kart track",
    COLOR "0 255 0 0" "Run over the baby penguin",
    COLOR "0 255 0 0" "Cross a cross-walk 30 times",
    COLOR "0 255 0 0" "Find Peter",
    COLOR "0 255 0 0" "Listen to all the radio tracks",
    COLOR "0 255 0 0""Mow down the basketball team"
...
if (gMarioState && gMarioObject) {
    ...
    i = 0;
for (i; i < 10; i+=1) {
    if (gMarioState->starsCollected[i+(10*pauseIndex)+1] == 1) {
        s2d_print_deferred(80, 60+(i*16), starNamesComplete[i+(10*pauseIndex)]);
    }
    else {
	s2d_print_deferred(80, 60+(i*16), starNames[i+(10*pauseIndex)]);
    }
}
