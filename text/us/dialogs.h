...
Welcome to the city!\n\
Press A or Z to accelerate.\n\
Press B to activate Cruise \n\
Control.\n\
Press DPAD Right to switch \n\
radio stations. \n\
Press START to see the \n\
star list. \n\
Press Z in the star list to\n\
go to the next star page. \n\
\n\
"))
