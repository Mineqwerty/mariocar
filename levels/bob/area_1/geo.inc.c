...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 394, 397, -1826, bob_dl_Cube_mesh),
		GEO_TRANSLATE_NODE_WITH_DL(5, -8674, 131, -22970, bob_dl_Plane_mesh_layer_5),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 303, 320, -1861, bob_dl_Plane_001_mesh),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
